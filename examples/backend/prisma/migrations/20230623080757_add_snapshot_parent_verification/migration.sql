/*
  ...
  - Added the required column `parentSnapshotUpdatesClocks` to the `Snapshot` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "parentSnapshotUpdatesClocks" JSONB NOT NULL,
